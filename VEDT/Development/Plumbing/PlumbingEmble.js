...
Purpose/Description: 
First time EMblers to see this modal window - can be access again via help menu dropdown

Author(s):
Carly Milanovic, RMIT Stud

Contributor(s):
*/

emble.canvas_api.welcomeEmble = function() {

    // IN DEVELOPMENT

    console.log('Show welcome for first timers');

    var msg = "<h2>Welcome to Emble</h2>";
    var closeDialog = function() {
        $('.modal-container').remove()
    };

    emble.ui.displayDialog('Emble', msg, 'Got it', closeDialog, '');
